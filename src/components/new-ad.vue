<template>
  <div class="maintop">
    <section class="new-adTop">新建广告</section>
    <!-- 警示-->
    <template>
      <el-alert title="广告平台已经正式上线，广告投放审核等问题可联系微信13439028040" type="warning">
      </el-alert>
    </template>
    <!-- 新建内容-->
    <section class="new-adCon clearfix">
      <div class="new-ad-left fl">
        <div class="newAd-step1 step">
          <p class="step-num">
            ...
            <span class="step-numActive">设置推广计划</span>
          </p>
          <p class="step-line step-lineActive"></p>
          <p class="step-num">
            <i :class="['step-round',currentstep==1?'step-active':'',currentstep==2?'step-active':'']">2</i>
            <span :class="[currentstep==1?'step-numActive':'',currentstep==2?'step-numActive':'']">新建广告</span>
          </p>
          <p :class="['step-line',currentstep==1?'step-lineActive':'',currentstep==2?'step-lineActive':'']"></p>
          <p class="step-num">
            <i :class="['step-round',currentstep==2?'step-active':'']">3</i>
      ...
      <div class="new-ad-right fl clearfix">
        <!-- 新建广告第一步骤-->
        <section class="new-ad-plan" v-show="stepArr[0]">
          <div class="new-ad-change">
            <ul class="new-ad-tab">
              <li :class="currentIndex==0?'changeActive':''" @click="changeplan(0)">创建新推广计划</li>
              <!--<li :class="currentIndex==1?'changeActive':''"@click="changeplan(1)">选择已有计划</li>-->
            </ul>
          </div>
          <div class="add-plan" v-show="showplan">
            <div class="plan-form max-inp">
              <el-form :label-position="labelPosition" label-width="80px" :model="formLabelAlign">
                <el-form-item label="推广计划名称">
                  <el-input v-model="formLabelAlign.name"></el-input>
                </el-form-item>
                <el-form-item label="每日最高预算">
                  <el-input v-model="formLabelAlign.region"></el-input>
                </el-form-item>
                <div class="toufang_spead">投放速度</div>
                <el-radio v-model="radio" label="1">标准投放</el-radio>
                <el-radio v-model="radio" label="2">加速投放</el-radio>
              </el-form>
            </div>
            <el-row>
              <el-button type="primary" @click="changeStep(0,'go')">下一步</el-button>
            </el-row>
          </div>
          <!-- 选择已有计划-->
          <!--<div class="choose-plan"v-show="!showplan">-->
          <!--<div class="choose-plan-con">-->
          <!--<div class="choose-sel max-inp">-->
          <!--<div class="choose-sel-tit">推广计划</div>-->
          <!--<template>-->
          ...
          <!--</template>-->
          <!--</div>-->
          <!--&lt;!&ndash; 每日最高预算一栏&ndash;&gt;-->
          <!--<div class="choose-sel-mod">-->
          <!--<div class="choose-sel-tit">每日最高预算</div>-->
          <!--<i>5000元</i>-->
          <!--</div>-->
          <!--<div class="choose-sel-mod">-->
          <!--<div class="choose-sel-tit">投放速度</div>-->
          <!--<i>标准投放</i>-->
          <!--</div>-->
          <!--<el-row>-->
...
export default {
  data() {
    return {
      ...
      value1: "",
      value6: "", //固定日期投放
      stepArr: [true, false, false], //控制下一步上一步
      currentstep: 0, //控制进度
